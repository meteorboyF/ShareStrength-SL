    ...
    <header class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4">
                <img src="{{ $user->profile_photo ?? 'https://placehold.co/100x100' }}" alt="Profile" class="h-12 w-12 rounded-full border-2 border-purple-600 object-cover">
                <div>
            ...
            <div class="flex items-center gap-4">
                <a href="#" onclick="event.preventDefault(); alert('Marketplace feature coming soon!')" class="hidden sm:inline-flex items-center gap-x-2 rounded-md bg-white px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 border border-slate-200 transition">
                    Marketplace
                </a>

                <a href="#" onclick="event.preventDefault(); alert('Shopping cart coming soon!')" class="relative p-2 text-gray-800 hover:text-purple-600 transition">
    ...
    <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:px-8">
        ...
        @if($showBanner)
            <section class="bg-purple-600 rounded-xl shadow-lg mb-8 relative overflow-hidden text-white p-6 flex flex-col sm:flex-row items-center justify-between animate-fade-in-up">
                ...
                <button onclick="alert('Marketplace coming soon!')" class="mt-4 sm:mt-0 bg-white text-purple-600 font-bold px-6 py-2 rounded-lg shadow hover:bg-gray-100 transition z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                            ...
                                            <div class="flex gap-2 flex-wrap">
                                                @if($task->status === 'accepted')
                                                    <button 
                                                        ...
                                                        class="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full hover:bg-blue-100 font-semibold"
                                                    >
                                                        ▶️ Start Task
                                                    </button>
                                                @endif
                                                ...
                                                @if($task->status === 'in_progress')
                                                    <button 
                                                        ...
                                                        class="text-xs bg-purple-50 text-purple-600 px-3 py-1 rounded-full hover:bg-purple-100 font-semibold"
                                                    >
                                                        ✓ Complete
                                                    </button>
                                                @endif
                                            ...
                                            @foreach($task->applications as $app)
                                                <div wire:key="app-{{ $app->id }}" class="flex justify-between items-center bg-white p-3 rounded-lg border border-gray-100">
                                                    <div class="flex items-center gap-3">
                                                        <img src="{{ $app->helper->profile_photo_url ?? 'https://placehold.co/150' }}" alt="{{ $app->helper->name }}" class="w-10 h-10 rounded-full">
                                                        <div>
                                                            <a href="#" class="font-bold text-sm hover:text-purple-600 hover:underline">
                                                                {{ $app->helper->name }}
                                                            </a>
            ...
            <aside class="space-y-8">
                ...
                <section class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm animate-fade-in-up delay-200">
                    ...
                    <ul class="space-y-4">
                        <!-- Placeholder static data or fetch dynamically -->
                ...
                <section class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm animate-fade-in-up delay-300">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <a href="{{ route('tasks.browse') }}" class="p-3 border border-gray-200 rounded-lg text-sm font-medium hover:bg-gray-50 hover:border-purple-600/50 transition text-center flex items-center justify-center text-gray-800 cursor-pointer">
                            Find Help
                        </a>
                    </div>
                </section>
