                ...
                <section>
                    <div class="flex justify-between items-end mb-5">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span class="text-sm font-medium text-slate-500 group-hover:text-slate-700">Payment History</span>
                        </label>
                    </div>
                    ...
                    <div class="space-y-4">
                        @if($tasks->isEmpty())
                            <div class="bg-white rounded-2xl border border-slate-200 p-10 text-center">
                                ...
                                <p class="text-slate-500 mt-2 mb-6">You haven't posted any help requests yet.</p>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        @php
                            $shortcuts = [
                                ...
                                ['label' => 'History', 'icon' => 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', 'route' => 'payment-history'],
