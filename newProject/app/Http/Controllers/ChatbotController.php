...
class ChatbotController extends Controller
{
    ...
    public function stream(Request $request, GeminiClient $gemini, QdrantClient $qdrant): StreamedResponse
    {
        ...
        $collection = (string) config('rag.qdrant.collection', 'newproject_knowledge');
        ...
        $systemInstruction = implode(' ', [
            'You are the in-app assistant.',
            'Help people navigate the site and complete common actions.',
