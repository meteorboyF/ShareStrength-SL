<div class="mx-auto max-w-md space-y-6">
    <div class="rounded-xl border border-gray-200 p-6 bg-white">
        ...
        <p class="mt-1 text-sm text-gray-600">You can remove this route later.</p>
    ...
    <div class="text-sm text-gray-600">
        Already have an admin account? <a class="text-gray-900 underline" href="{{ route('admin.login') }}">Login</a>
    </div>
</div>
