<div class="mx-auto max-w-md space-y-6">
    <div class="rounded-xl border border-gray-200 p-6 bg-white">
        <h1 class="text-xl font-semibold">Register (Provider)</h1>
    ...
    <div class="text-sm text-gray-600">
        Already have an account? <a class="text-gray-900 underline" href="{{ route('provider.login') }}">Login as provider</a>
    </div>
</div>
