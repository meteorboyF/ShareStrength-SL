      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 space-y-4">
            {cart.map((item) => (
              <div key={item.product_id} className="bg-white p-4 rounded-xl shadow-sm border border-neutral-200 flex items-center gap-4">
                <img
                  src={item.image_url}
                  alt={item.name}
                ...
                <div className="flex items-center gap-3">
                  <button onClick={() => updateQuantity(item.product_id, -1)} className="w-8 h-8 rounded-full bg-neutral-100 flex items-center justify-center hover:bg-neutral-200 font-bold">-</button>
